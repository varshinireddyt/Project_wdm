...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="ModifySkills.php" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
      <label for="uname"><b>Month</b></label>
      <input type="text" placeholder="Enter Month" name="month" required>
      ...
      <label for="text"><b>Retype Role</b></label>
      <input type="text" placeholder="Retype Role" name="retyperole" required>
      
      <label for="text"><b>Description</b></label>
      <input type="text" placeholder="enter Description" name="description" required>
        
      <button type="submit" name="insertexperience">Insert</button>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="ModifySkills.php" method="post" enctype="multipart/form-data">
    ...
    <center><h2> Update Experience </h2> </center>

    <div class="container">
      <label for="uname"><b>Enter Experience Number</b></label>
      <input type="text" placeholder="Enter Experience number" name="experiencenumber" required pattern="[0-9]{1}">

      <label for="uname"><b>Select Input</b></label>
      <input type="text" name="inputexp" list="cityname" required>
      ...
      <input type="text" placeholder="Type New Value" name="newinput" required>         
...
<div id="id03" class="modal">
  ...
  <form class="modal-content animate" action="ModifySkills.php" method="post" enctype="multipart/form-data">
    ...
    <center><h2> Delete Experiences</h2> </center>

    <div class="container">
      <label for="uname"><b>Enter Experience number to delete</b></label>
      <input type="text" placeholder="Enter experience number" name="experiencenumber" required pattern="[0-9]{1}">


      <button type="submit" name="deleteexperience">Delete</button>
